  ...
  function aboutController() {
    ...
    aboutCtrl.content = [
                          ...
                          },
                          {
                            ...
                            paragraphs: ["It all started in my first year of my with my first course in programming for Electrical Engineering. Having never programmed before, I didn’t do too well in that course and it made me want to get better at programming. As I started writing more code, <span>I figured I liked programming more than being in engineering and I made the switch to Computer Science.</span>"]
                          },
                          {
                            ...
                            paragraphs: [
                              ...
                              "However, languages are not everything in programming. I’m currently learning full-stack web development. <span>My specialities are object-oriented programming, web development and computer networking.</span>",
                          ...
                          },
                          {
                            ...
                            paragraphs: [
                              "At the start of 2011, I joined Carleton Toastmasters after feeling my communication skills were not up to par. I was also very shy and nervous at that time, which made me very hesitant about preparing and performing speeches. <span>Once my first speech was delivered, I did not look back ever since with regards to improving my communication skills.</span>",
